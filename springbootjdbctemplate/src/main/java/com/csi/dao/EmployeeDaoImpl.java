...
public class EmployeeDaoImpl implements EmployeeDao {
    ...
    String INSERT_SQL="insert into employee2(empid,empname,empaddress,empcontactnumber,empsalary,empdob,empemailid) values(?,?,?,?,?,?,?)";
    String SELECT_ALL_SQL="select * from employee2";

    String UPDATE_SQL="update employee2 set empname=?,empaddress=?,empcontactnumber=?,empsalary=?,empdob=?,empemailid=? where empid=?";

    String DELETE_BY_ID_SQL="delete from employee2 where empid=?";
